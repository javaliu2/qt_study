...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent) {
    ...
    topFiller->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Expanding);  // 第一个参数水平，第二个参数垂直
    ...
    QString message = tr("A context menu is avaliable by right-clicking");
...
void MainWindow::contextMenuEvent(QContextMenuEvent* event) {
    ...
    menu.exec(event->globalPos());  // what mean? 创建一个模态的菜单，即会阻塞当前application
}
#endif

void MainWindow::newFile() {
    infoLabel->setText(tr("Invoked <b>File|New</b>"));  // <b>content</b>: 会加粗content
}
...
void MainWindow::createActions() {
    newAct = new QAction(QIcon::fromTheme(QIcon::ThemeIcon::DocumentNew), tr("&New"), this);  // &New中的&是助记符，显示为N下面有下划线，可以使用Alt激活
    ...
    // qApp是一个宏(static_cast<QApplication *>(QCoreApplication::instance()))，表示指向当前application对象的指针
